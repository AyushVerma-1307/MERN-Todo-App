...
const Card = ({ setTodoData,todoData,todo}) => {
    ...
    const subDescription = readmore ? description : words.slice(0, 20).join(' ');
    ...
    return (
        <div className='w-[300px] h-max p-2 m-[1rem] flex flex-col rounded-2xl items-center transition-all bg-slate-200 shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]  hover:scale-105 sm:hover:scale-110 md:hover:scale-105 lg:hover:scale-110 hover:shadow-[0_10px_40px_rgba(240,_46,_170,_0.7)]'>
            ...
            <div className='flex justify-center items-center pt-7 ml-1 mr-1'>
